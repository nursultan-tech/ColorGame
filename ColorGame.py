...
root.configure(background='#F12F29')
...
gameOverLabel = tkinter.Label(cont, text="Game Over",
                              font=('Helvetica', 12))
restartButton = tkinter.Button(cont, text="Restart the game", fg='red',bg='black')
